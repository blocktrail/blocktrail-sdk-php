            ...
            <html>
                ...
                <body>
                    <header>
                        ...
                        <p>This document holds the information and instructions required for you to recover you Blocktrail wallet should anything happen. </p>
                    </header>
                    <section class="backup-info">
                        <div class="primary-mnemonic">
                            <h2>Primary Mnemonic</h2>
